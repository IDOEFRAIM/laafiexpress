      ...
      <div className="relative w-full overflow-hidden bg-white border-y border-slate-200 py-12">
        ...
        <div className="animate-infinite-scroll">
          {[...logos, ...logos].map((logo, index) => (
            <div 
              key={index} 
              className="flex flex-col items-center justify-center w-70 px-10 border-r border-slate-100 last:border-r-0 group"
            >
              <div className="relative h-16 w-full flex items-center justify-center filter  contrast-125 opacity-80 group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-700">
                <Image 
                  width={200}
                  height={80}
                  src={logo.url} 
